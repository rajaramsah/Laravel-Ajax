        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="name form-control" id="floatingInput" placeholder="Full Name" required>
                    <label for="floatingInput">Full Name</label>
                </div>

             
                <div class="form-floating mb-3">
                    <input type="text" class="course form-control" id="floatingInput" placeholder="Course" required>
                    <label for="floatingInput">Course</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="email" class="email form-control" id="floatingInput" placeholder="Email" required>
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="phone form-control" id="floatingInput" placeholder="Phone" required>
                ...
                <div class="card-header">
                    <h4>
                        ...
                        <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal"
                            data-bs-target="#AddStudentModal"><i class="fa fa-user-plus"></i></button>
                    </h4>
                </div>
                <div class="card-body">
                ...
                success: function (response) {
                    ...
                    $.each(response.students, function (key, item) {
                        $('tbody').append('<tr>\
                            ...
                            <td>' + item.email + '</td>\
                            <td>' + item.phone + '</td>\
                            <td><button type="button" value="' + item.id + '" class="btn btn-warning editbtn btn-sm"><i class="fa fa-pencil"></i></button></td>\
                            <td><button type="button" value="' + item.id + '" class="btn btn-danger deletebtn btn-sm"><i class="fa fa-trash"></i></button></td>\
                        \</tr>');
                    });
                }
            });
